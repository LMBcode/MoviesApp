...
import com.example.moviesapp.actors.RetrofitAdapterActors
...
import com.example.moviesapp.databinding.UpcomingTvBinding


class PopularPersonsFragment : Fragment() {
    private lateinit var _binding : UpcomingTvBinding
    private val binding get() = _binding
    private lateinit var layoutManager : LinearLayoutManager
    private lateinit var adapter : RetrofitAdapterActors
    ...
    override fun onCreateView(
        ...
        _binding = UpcomingTvBinding.inflate(inflater,container,false)
        return binding.root
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        adapter = RetrofitAdapterActors(mutableListOf()){ movie -> getArgs(movie)}
    ...
    fun getUpcomingTV(){
        RetrofitInstance.getUpcomingTV( onSuccess = ::getData , onError = ::onError)
    }
