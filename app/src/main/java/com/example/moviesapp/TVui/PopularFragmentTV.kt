...
class PopularFragmentTV : Fragment() {
    private lateinit var _binding : FragmentPopulartvBinding
    ...
    fun getPopularTV(){
        RetrofitInstance.getTVpopular(popularMoviesPage, OnSuccess = ::Movies , OnError = ::onError )
    }
