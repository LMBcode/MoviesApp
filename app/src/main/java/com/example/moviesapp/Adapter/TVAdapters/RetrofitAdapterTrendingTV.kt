...
class RetrofitAdapterTrendingTV(private var movies : MutableList<Movie>, private val onMovieClick : (movie : Movie) -> Unit) : RecyclerView.Adapter<RetrofitAdapterTrendingTV.ViewHolder>() {
